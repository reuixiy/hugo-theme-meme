...
```sh
~ $ cd blog
~/blog $ git config --global init.defaultBranch main # 更改 git 默认分支名称为 "main"
~/blog $ git init
...
1. 将 `hugo.toml` 替换为[示例配置](https://github.com/reuixiy/hugo-theme-meme/blob/master/config-examples/zh-cn/config.toml)。
